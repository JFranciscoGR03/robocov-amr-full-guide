...
class PathPlannerNode(Node):
    def __init__(self):
        ...
        # Rutas
        self.yaml_path = '/home/jumpers/maps/robocov_map_circuito_edited.yaml'
        self.pgm_path = '/home/jumpers/maps/robocov_map_circuito_edited.pgm'
        ...
        self.auto = False
        self.get_logger().info("PathPlannerNode listo para jalar. Esperando punto de goal.")
